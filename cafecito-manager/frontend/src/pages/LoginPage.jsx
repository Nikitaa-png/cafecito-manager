  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=1200&q=80" alt="Coffee" className="w-full h-full object-cover" />
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-[#2a1f1a] rounded-3xl shadow-2xl p-8 border border-[#e8d8ce] dark:border-[#3d2b22]">
            ...
            <p className="text-[#8b5a44] dark:text-[#c4a89a] text-sm mb-8">
              Don't have an account? <Link to="/register" className="text-[#6b3a2a] dark:text-[#c4846a] font-semibold hover:underline">Sign up</Link>
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  <FiMail className="absolute left-4 top-1/2 -translate-y-1/2 text-[#c4a89a]" />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showPwd ? 'text' : 'password'} value={form.password} onChange={e => setForm(p => ({ ...p, password: e.target.value }))} required
                    className="input pl-11 pr-12" placeholder="••••••••" />
              ...
              <motion.button whileTap={{ scale: 0.98 }} type="submit" disabled={loading}
                ...
                {loading ? <><span className="w-4 h-4 border-2 border-[#f5ede6] border-t-transparent rounded-full animate-spin" />Signing In…</> : 'Sign In'}
              </motion.button>
            </form>
          </div>
        </motion.div>
